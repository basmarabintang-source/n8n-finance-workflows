...
The payment run and bank reconciliation were fixed on 16 September 2026, after checking their
READMEs against the workflows found real defects. Their numbers above are from the previous version
and are being re-run; each folder's README lists what changed.
